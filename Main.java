...
class Main {
    ...
    public static void main(String[] args) {
        ...
        // ===== Challenge 3 =====
        // Find value of B and C, letting 0<m<1 and −1<cp<1 at T = 0
        Challenge3();
    ...
    public static void Challenge3() {
        System.out.println("Seeking For Value of B, C...");
        double B=0.1, C=-0.1, T=0.01;
        int N = 100;
        int Nt = 1000;
        ...
        for (; B<=2; B+=0.1) {
            for (; C>=-2; C-=0.1) {
                ...
                try {
                    ...
                    double m = threadList.get(0).globalMeanM;
                    double cp = threadList.get(0).globalMeanC;
                    // System.out.println("B="+B+" C="+C +" <m>:"+m+" <cp>=" +cp );
                    if (m>0.01 && m <0.99 && cp>-0.99 && cp<0.99) {
    ...
    // determine a single pair of B_C
